...
export const sendEmailVerificationEmail = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    const subject = "Verify your VisaClear email";
    const siteUrl = process.env.SITE_URL || "https://visaclear.app";
    const confirmUrl = `${siteUrl}/verify-email/${token}`;
    const html = `
<!DOCTYPE html>
<html>
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:40px 40px 32px;">
            <h2 style="font-family:Georgia,serif;font-size:22px;color:#0f2040;margin:0 0 16px;font-weight:600;">Hi ${safeName}, verify your email.</h2>
            <p style="font-size:14px;color:#666;line-height:1.7;margin:0 0 24px;">
              One quick step to confirm this address is really yours — this unlocks posting in the Community, contacting agents, and starting a paid trial. This link expires in 24 hours and can only be used once.
            </p>
            ...
            <p style="font-size:12px;color:#999;line-height:1.6;text-align:center;font-style:italic;margin:0;">
              If you didn't create a VisaClear account, you can safely ignore this email.
            </p>
          </td>
        </tr>
        <tr>
