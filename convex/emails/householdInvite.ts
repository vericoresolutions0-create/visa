      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:40px 40px 32px;">
            <h2 style="font-family:Georgia,serif;font-size:22px;color:#0f2040;margin:0 0 16px;font-weight:600;">${safeHouseholdName} wants to follow your visa readiness.</h2>
            <p style="font-size:14px;color:#666;line-height:1.7;margin:0 0 16px;">
              A family member is using VisaClear to track everyone's visa progress in one place. If you accept, they will be able to see your overall readiness percentage and a simple status (Ready / Needs Attention / Not Started) for the relocation you choose to link.
            </p>
